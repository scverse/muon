...
def filter_obs(adata: AnnData,
	...
	if isinstance(var, str):
		if var in adata.obs.columns:
			...
			raise ValueError(f"Column name from .obs or one of the var_names was expected but got {var}.")
	else:
		if func is None:
...
def filter_var(adata: AnnData,
	...
	if isinstance(var, str):
		if var in adata.var.columns:
			...
			raise ValueError(f"Column name from .var or one of the obs_names was expected but got {var}.")
	else:
		if func is None:
